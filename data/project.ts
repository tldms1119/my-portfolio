...
export const projects: Project[] = [
  {
    ...
    overview:
      "Internal project aimed at automating manual data entry by using OCR to improve operational efficiency",
    contributions: [
      {
        area: "Backend",
        percentage: 80,
  ...
  },
  {
    ...
    role: "Project Manager / Full-stack Developer",
    overview:
      "B2B Project delivering an ESG assessment platform designed for small and mid-sized companies",
    contributions: [
      {
  ...
  },
  {
    ...
    overview:
      "R&D project launched by the Korean government to provide information on the average body sizes of Koreans",
    contributions: [
      {
      ...
      },
      {
        area: "Deployment",
        percentage: 50,
        description: ["Deployed in an on-premise server environment"],
        techStack: [],
      },
    ],
  },
  {
    ...
    role: "Project Manager / Full-stack Developer",
    overview:
      "An iOS bulletin board app for sharing daily prayers and devotional posts within a church community",
    contributions: [
      {
        area: "Backend",
        percentage: 100,
  ...
  {
    id: "algorithm-handbook",
    title: "Algorithm Handbook",
    category: "personal",
    liveUrl: "https://github.com/tldms1119/algorithm-handbook",
    role: "Consistent Learner",
    overview:
